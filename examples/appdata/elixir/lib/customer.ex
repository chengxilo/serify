...
defmodule Address do
  @moduledoc """
  Mirrors the reusable examples/appdata/cases/address.yaml, imported by customer and
  order.
...
defmodule Money do
  @moduledoc "Mirrors the reusable examples/appdata/cases/money.yaml, imported by customer and order."
  use WorkerLib.Serify.Model
