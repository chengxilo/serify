...
// LineItem mirrors examples/appdata/cases/line_item.yaml, imported by order.
...
// examples/appdata/cases/order.yaml. An enum travels as its variant *name*; the ordinal
...
// OrderRecord mirrors examples/appdata/cases/order.yaml. Between them its fields cover
