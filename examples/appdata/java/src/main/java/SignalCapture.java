...
/**
 * Mirrors examples/appdata/cases/signals.yaml, which uses every scalar the schema allows
 * as a list element.
 *
 ...
 *
 * <p>Go is the --ref language and owns the byte layout; see examples/appdata/go/wire.go.
