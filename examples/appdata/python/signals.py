...
"""`SignalCapture` mirrors examples/appdata/cases/signals.yaml, which uses every scalar
...
Go is the --ref language and owns that layout; see examples/appdata/go/wire.go.
"""
