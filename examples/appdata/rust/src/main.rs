...
//!
//! The Go worker (examples/appdata/go) is the --ref language and owns the byte layout;
//! see the layout comment at the top of examples/appdata/go/wire.go.
//!
...
//! examples/appdata/cases/expected_skips/ for what the other workers still owe.
