...
//!
//! The Go worker (examples/appdata/go) is the --ref language and owns the layout these
//! reproduce; see the layout comment at the top of examples/appdata/go/wire.go.
